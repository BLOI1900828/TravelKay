...
<head>
    ...
    <link rel="stylesheet" href="./public/frontend/css/Step2.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" integrity="sha512-z3gLpd7yknf1YoNbCzqRKc4qyor8gaKU1qmn+CShxbuBusANI9QpRohGBreCFkKxLhei6S9CQXFEbbKuqLg0DA==" crossorigin="anonymous" referrerpolicy="no-referrer" />

    <title>Contact Infor</title>
</head>
        ...
        <div class="box_left  column">
            <div class="box_step center column">
                ...
                <div class="r3 row space_a">
                    ...
                    <p class="uper text_step">contact infor</p>
            ...
            <form class="box_form" action="" method="post">
                <div class="header_form">
                    <p class="text_big cap">contact info:</p>
                    <p class="cap">Fill in your account details</p>
                </div>
                <div class="lb">
                    <p class="uper text_verry_small text_B">Company Name *</p>
                    <input class="inp_form" type="text" name="company" placeholder="Company Name">
                </div>
                <div class="lb">
                    <p class="uper text_verry_small text_B">address *</p>
                    <input class="inp_form" type="text" name="address" placeholder="Address">
                </div>
                <div class="lb">
                    <p class="uper text_verry_small text_B">phone no *</p>
                    <input class="inp_form" type="text" name="phone" placeholder="Phone No">

                </div>
                <div class="lb">
                    <p class="uper text_verry_small text_B">city *</p>
                    <input class="inp_form" type="text" name="city" placeholder="Country Name">

                </div>
                <div class="lb">
                    <p class="uper text_verry_small text_B">state provience *</p>
                    <input class="inp_form" type="text" name="state" placeholder="State Provience">
